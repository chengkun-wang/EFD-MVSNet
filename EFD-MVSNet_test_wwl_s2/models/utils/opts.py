...
def get_opts():
    ...
    parser.add_argument('--var_reg_dim_stages', type=str, default="64,32,16,8", help='group correlation dim')
    ...
    parser.add_argument('--testpath', default="/home/ubuntu/home/wck/data/mvs_training/dtu/",
                        help='data path for testing')
    parser.add_argument('--trainlist', default="./datasets/lists/dtu/train.txt", help='data list for training')
    parser.add_argument('--testlist', default="./datasets/lists/dtu/val.txt", help='data list for testing')
