...
if __name__ == '__main__':
    ...
    if is_distributed:
        ...
        TrainImgLoader = DataLoader(train_dataset, args.batch_size, sampler=train_sampler, num_workers=0, drop_last=True, pin_memory=args.pin_m)
        TestImgLoader = DataLoader(test_dataset, args.batch_size, sampler=test_sampler, num_workers=0, drop_last=False, pin_memory=args.pin_m)
    else:
