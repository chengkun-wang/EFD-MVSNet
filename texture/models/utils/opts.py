...
def get_opts():
    ...
    # global settings
    parser.add_argument('--mode', default='test', help='train or test', choices=['train', 'test', 'val'])
    parser.add_argument('--which_dataset', default='dtu', choices=['dtu', 'tnt', 'blendedmvs'],
    ...
    parser.add_argument('--hypo_plane_num_stages', type=str, default="8,8,4,4",
                        help='num of hypothesis planes for each stage')
    parser.add_argument('--depth_interal_ratio_stages', type=str, default="0.5,0.5,0.5,1",
    ...
    parser.add_argument('--batch_size', type=int, default=1, help='batch size for training')  # 4
    parser.add_argument('--data_scale', type=str, default="raw",
                        help='use mid or raw resolution')  # choices=['mid', 'raw'],
    parser.add_argument('--trainpath', default="/home/ubuntu/home/wck/data/mvs_training/dtu/",
                        help='data path for training')
    parser.add_argument('--testpath', default="/home/ubuntu/home/wck/CVP-MVSNet-master/data/dtu-test-1200/",
                        help='data path for testing')
    ...
    parser.add_argument('--robust_train', default=True, help='robust training')  # action='store_true',

    # testing config
    parser.add_argument('--split', type=str, choices=['intermediate', 'advanced'],
    ...
    parser.add_argument('--loadckpt', default="/home/ubuntu/home/wck/GeoMVSNet-master/checkpoints/dtu/geomvsnet/model_geomvsnet_release.ckpt", help='load a specific checkpoint')
    parser.add_argument('--logdir', default='./checkpoints/dtu/geomvsnet', help='the directory to save checkpoints/logs')
    ...
    parser.add_argument('--outdir', default='./outputs/dtu/geomvsnet', help='output dir')
