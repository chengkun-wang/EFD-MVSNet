...
parser.add_argument('--root_path', type=str, default='/home/ubuntu/home/wck/CVP-MVSNet-master/data/dtu-test-1200/')
parser.add_argument('--depth_path', type=str,
                    default='/home/ubuntu/home/wck/GeoMVSNet_test_1/outputs/dtu/geomvsnet_raw/')
parser.add_argument('--data_list', type=str, default='/home/ubuntu/home/wck/GeoMVSNet_test_1/datasets/lists/dtu/test.txt')
parser.add_argument('--ply_path', type=str,
                    default='/home/ubuntu/home/wck/GeoMVSNet_test_1/outputs/dtu/geomvsnet_raw/open3d_fusion_plys/')
parser.add_argument('--dist_thresh', type=float, default=0.2)
