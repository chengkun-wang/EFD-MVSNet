...
def get_opts():
    ...
    parser.add_argument('--loadckpt', default="/home/ubuntu/home/wck/GeoMVSNet_test_1/checkpoints/dtu/geomvsnet_raw/model_10.ckpt", help='load a specific checkpoint')
    parser.add_argument('--logdir', default='./checkpoints/dtu/geomvsnet_raw', help='the directory to save checkpoints/logs')
    ...
    parser.add_argument('--outdir', default='./outputs/dtu/geomvsnet_raw', help='output dir')
